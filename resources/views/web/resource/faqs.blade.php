            ...
            <div class="accordion" id="accordionExample">
                <div class="accordion-item mt-4">
                    <h2 class="accordion-header">
                        <button aria-label="Name" class="accordion-button" type="button" data-bs-toggle="collapse"
                ...
                <div class="accordion-item mt-4">
                    <h2 class="accordion-header">
                        <button aria-label="Name" class="accordion-button collapsed" type="button"
                            ...
                            How can Law Accent Nigeria assist my business?
                        </button>
                    </h2>
                ...
                <div class="accordion-item mt-4">
                    <h2 class="accordion-header">
                        <button aria-label="Name" class="accordion-button collapsed" type="button"
                            ...
                            What services does Law Accent Nigeria offer?
                        </button>
                    </h2>
                ...
                <div class="accordion-item mt-4">
                    <h2 class="accordion-header">
                        <button aria-label="Name" class="accordion-button collapsed" type="button"
                            ...
                            Does Law Accent Nigeria handle both individuals and businesses?
                        </button>
                    </h2>
                ...
                <div class="accordion-item mt-4">
                    <h2 class="accordion-header">
                        <button aria-label="Name" class="accordion-button collapsed" type="button"
                            data-bs-toggle="collapse" data-bs-target="#collapseFive" aria-controls="collapseFive">
                ...
                <div class="accordion-item mt-4">
                    <h2 class="accordion-header">
                        <button aria-label="Name" class="accordion-button collapsed" type="button"
                            data-bs-toggle="collapse" data-bs-target="#collapseSix" aria-controls="collapseSix">
                ...
                <div class="accordion-item mt-4">
                    <h2 class="accordion-header">
                        <button aria-label="Name" class="accordion-button collapsed" type="button"
                            data-bs-toggle="collapse" data-bs-target="#collapseSeven" aria-controls="collapseSeven">
                ...
                <div class="accordion-item mt-4">
                    <h2 class="accordion-header">
                        <button aria-label="Name" class="accordion-button collapsed" type="button"
                            data-bs-toggle="collapse" data-bs-target="#collapseEight" aria-controls="collapseEight">
                            Can I get legal assistance online?
                        </button>
                    </h2>
