                ...
                <div class="row">
                    <div
                        ...
                        <div class="login-brand">
                            {{-- <img src="{{ asset('web/{{ asset("web/assets/images/logo.webp') }}" alt="logo" width="100" class="shadow-light rounded-circle"> --}}
                            <img src="{{ asset('web/{{ asset("web/assets/images/logo.webp') }}" alt="logo" width="200" class="shadow-ligh">
                            {{-- Admin Login --}}
                        </div>
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                <form method="POST" method="POST" action="{{ route('login.authenticate') }}">
                                    @csrf
