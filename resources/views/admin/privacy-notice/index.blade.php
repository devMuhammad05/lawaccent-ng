    ...
    <section class="section">
        ...
        {{-- <div class="card card-primary">
            ...
            <div class="card-body">
                ...
                <p>Effective Date:
                    [<span id="date">{{ optional(SiteSetting::first())->privacy_notice_effective_date->format('d/m/Y') }}</span>]
                </p>
                ...
                <form action="{{ route('admin.site-settings.update', ['site_setting' => SiteSetting::first()]) }}" method="POST">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="form-group w-50">
                            ...
                            <input type="date"
                                   class="form-control"
                                   name="privacy_notice_effective_date"
                                   data-date-format="dd/mm/yyyy"
                                   value="{{ optional(SiteSetting::first())->privacy_notice_effective_date->format('Y-m-d') }}">
                        </div>
                        <div>
        ...
        <div class="card card-primary">
            <div class="card-header">
              ...
              <div class="card-header-action">
                <a href="{{ route('admin.privacy-notice.create') }}" class="btn btn-primary">
                  Create new
                </a>
              </div>
